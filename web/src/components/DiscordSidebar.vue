        ...
        <ul class="nav-list">
          ...
          <li>
            ...
            >
              ...
              <span v-if="unreadArchiveCount > 0" class="nav-badge">{{ unreadArchiveCount }}</span>
            </button>
          </li>
          ...
          <li>
            <button
              class="nav-item"
              :class="{ active: selectedTag === 'drafts' }"
              @click="$emit('select', 'drafts')"
            >
              <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
              </svg>
              <span class="nav-label">Drafts</span>
              <span v-if="draftsCount > 0" class="nav-badge">{{ draftsCount }}</span>
            </button>
          </li>
...
export default {
  ...
  computed: {
    ...
    draftsCount() {
      return this.messageCounts?.drafts || 0;
    }
  },
  async created() {
    await this.loadTags();
