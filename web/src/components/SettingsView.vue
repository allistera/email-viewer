        ...
        <div v-else>
          <div v-for="rule in rules" :key="rule.id" class="rule-item" :class="{ disabled: !rule.is_enabled }">
            ...
            <div class="rule-actions">
              <button class="btn-icon" type="button" @click="editRule(rule)" title="Edit rule">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
                </svg>
              </button>
              <button class="btn-icon btn-danger" type="button" @click="confirmDeleteRule(rule)" title="Delete rule">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div v-if="deleteConfirm" class="modal-overlay" @click.self="deleteConfirm = null">
      <div class="modal">
        ...
        <div class="modal-actions">
          ...
          <button class="btn-secondary" type="button" @click="deleteConfirm = null">Cancel</button>
        </div>
      </div>
    </div>
  </section>
